# Katton Alpha 0.4.0 — Release Notes
...
- Added bilingual generated API documentation for common, Fabric, NeoForge,
  and Paper APIs.
- Fixed NeoForge production Jar-in-Jar scanning by removing optional JLine
  provider declarations whose implementations are absent from Kotlin's
  embeddable compiler artifact.
...
The release attaches six platform/version deployment jars and a `SHA256SUMS`
file generated by:
