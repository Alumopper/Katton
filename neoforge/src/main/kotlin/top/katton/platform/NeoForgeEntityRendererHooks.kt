...
object NeoForgeEntityRendererHooks : EntityRendererHooks {

    init { EntityRendererHooks.setInstance(this) }

    private val LOGGER = LoggerFactory.getLogger(NeoForgeEntityRendererHooks::class.java)
    ...
    override fun unregisterRenderer(entityType: EntityType<*>): Boolean {
        ...
        if (removed != null) rendererByStateClass.entries.removeAll { it.value == removed }
        return removed != null
    }
