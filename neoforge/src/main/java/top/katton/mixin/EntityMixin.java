...
import top.katton.api.event.AfterEntityChangeLevelArg;
...
abstract class EntityMixin {
    ...
    private Entity afterDimensionChanged(Entity instance, ServerLevel sourceLevel, ServerLevel targetWorld, TeleportTransition teleportTransition, Operation<Entity> original) {
        ...
        if (ret != null) {
            ServerEntityEvent.onAfterEntityChangeLevel.invoke(new AfterEntityChangeLevelArg((Entity) (Object) this, ret, (ServerLevel) this.level, (ServerLevel) ret.level()));
        }
