...
import top.katton.api.event.LootTableModifyDropsArg;
import top.katton.util.FabricLootTable;
import top.katton.util.LootUtil;
...
class LootTableMixin implements FabricLootTable {
    ...
    private void fabric$modifyDrops(LootContext context, Consumer<ItemStack> lootConsumer, Operation<Void> original) {
        ...
        LootTableEvent.onLootTableModifyDrops.invoke(new LootTableModifyDropsArg(
                this.holder,
                context,
                list
        ));
